...
/**
 * Edit estimate route - modify project estimate data
 *
 * WHY: Placeholder for estimate editing interface with WBS structure
 */
export const Route = createFileRoute("/project/$projectId/settings/estimate")({
      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Modify project estimate quantities, man-hours, and WBS structure. Changes will update
            progress calculations accordingly.
          </p>
        </div>
